...
{
    /// <summary>
    /// Meca500 프리셋 포즈 정의입니다.
    /// Home(영점), Ready(작업 준비), Folded(접힘) 포즈를 제공합니다.
    /// </summary>
    public static class Meca500PosePresets
    {
        /// <summary>
        /// 프리셋 포즈 구조체입니다.
        /// </summary>
        ...
        /// <summary>
        /// Home 포즈 (Meca500 기본 홈 자세)입니다.
        /// </summary>
        public static readonly Preset Home = new Preset(
            "Home",
            "Meca500 기본 홈 자세 (모든 관절 0°)",
        ...
        public static readonly Preset Folded = new Preset(
            "Folded",
            "접힌 자세 (J2=-70°, J3=70°, J5=-90°)",
            new double[] { 0, -70, 70, 0, -90, 0 });
