...
{
    /// <summary>
    /// FR5 DH 파라미터 기반 FK 계산 facade입니다.
    /// DH 편집과 관절값 변경에 따른 FK 결과를 이벤트로 전파합니다.
    /// </summary>
    public sealed class FR5KinematicsFacade
    {
        ...
        /// <summary>
        /// FR5 템플릿으로 facade를 생성합니다.
        /// </summary>
        public FR5KinematicsFacade()
        {
            baseTemplate = TemplateFAIRINO_FR5.Create();
