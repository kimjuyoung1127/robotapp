...
namespace KineTutor3D.App.UniversalRobots
{
    ...
    /// </summary>
    public static class UR5ePosePresets
    {
        /// <summary>
        /// 프리셋 포즈 구조체입니다.
        /// </summary>
        ...
        /// <summary>
        /// Home 포즈 (UR5e 기본 홈 자세)입니다.
        /// </summary>
        public static readonly Preset Home = new Preset(
            "Home",
            "UR5e 기본 홈 자세 (J2=-90°, J4=-90°)",
            new double[] { 0, -90, 0, -90, 0, 0 });

        /// <summary>
        /// Ready 포즈 (팔 뻗은 작업 준비 자세)입니다.
        /// </summary>
        public static readonly Preset Ready = new Preset(
            "Ready",
            "작업 준비 자세 (팔 뻗음)",
            new double[] { 0, -45, -90, -45, 90, 0 });
