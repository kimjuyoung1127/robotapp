...
namespace KineTutor3D.App.UniversalRobots
{
    ...
    public sealed class MockUR5eClient : IFairinoRobotClient
    {
        ...
        public FairinoResult SetRealtimeStateSamplePeriod(int periodMs)
        {
            ...
            return FairinoResult.Ok("Mock UR5e 상태 주기 설정 완료");
        }
        ...
        public FairinoResult ClearMotionQueue()
        {
            return !IsConnected
                ...
                : FairinoResult.Ok("Mock UR5e 모션 큐 비움");
        }
        ...
        public FairinoResult SetMode(int mode)
        {
            ...
            currentMode = mode;
            return FairinoResult.Ok($"Mock UR5e 모드 전환: {mode}");
        }
        ...
        public FairinoResult SetReconnect(bool enable, int timeoutMs, int periodMs)
        {
            return !IsConnected
                ? FairinoResult.Fail(-1, "연결되지 않은 상태입니다.")
                : FairinoResult.Ok("Mock UR5e 재연결 정책 적용");
        }
        ...
        public FairinoResult ExitDragTeach()
        {
            ...
            inDragTeach = false;
            return FairinoResult.Ok("Mock UR5e drag teach 종료");
        }
        ...
        public FairinoResult EnsureAutoMode()
        {
            ...
            currentMode = 0;
            return FairinoResult.Ok("Mock UR5e 자동 모드 전환");
        }
        ...
        public FairinoResult ResetErrors()
        {
            ...
            return FairinoResult.Ok("Mock UR5e fault reset 완료");
        }
