...
| tutor-step-add | UI | Assets/Scripts/UI/StepTutorPanel.cs, Assets/Scripts/UI/DHTableEditor.cs, Assets/Scripts/UI/TemplateSelector.cs, Assets/Scripts/UI/MatrixDisplay.cs | docs/ref/architecture-diagrams.md, docs/ref/USER-FLOW.md | robot-template-add | `theta` read-only + `d/a/alpha` 편집 반영, `A1/A2/T02` 실시간 갱신 |
