...
| open | `Easy Motion` gripper confirm/debug flow를 단순화하고 operator wording을 정리 | [FR5-LIVE-INTEGRATION-ROADMAP.md](./FR5-LIVE-INTEGRATION-ROADMAP.md), [fr5-gripper-live-success-pattern.md](../ref/product/roadmap/fr5-gripper-live-success-pattern.md) |
