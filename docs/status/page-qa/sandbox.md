...
- [ ] Home/Robot Library로 나가는 exit 경로가 분명하다.
...
- scene: `Sandbox.unity`
- objects: `SandboxActionContent`, `SnapshotContent`, `BtnZeroPose`, `BtnSaveSnapshot`, `BtnBackHome`, `BtnOpenRobotLibrary`
