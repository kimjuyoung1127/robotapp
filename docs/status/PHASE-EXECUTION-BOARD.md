...
|-------|--------|----------|--------|-------|----------------|----------------|--------------|
| Phase 0 | Foundation | P0 | InProgress | claude | - | docs/status/PROJECT-STATUS.md | 2026-03-05 |
| Phase 1 | Types | P0 | Ready | - | math-module-add | docs/ref/dh-reference.md | 2026-03-05 |
| Phase 1 | Math | P0 | Ready | - | math-module-add, editmode-test-add | docs/ref/dh-reference.md | 2026-03-05 |
